...
namespace Oberon0.Shared
{
    ...
    public class CreateBinaryOptions
    {
        ...
        /// </summary>
        public bool CleanSolution { get; set; } = false;
        ...
        /// </remarks>
        public string FrameworkVersion { get; set; } = "netcoreapp3.1";
        ...
        /// <summary>
        /// Set of additional (output target specific entries)
        /// </summary>
        public IDictionary<string, object> TargetOptions { get; set; }
