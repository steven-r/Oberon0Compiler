...
namespace Oberon0.Compiler.Expressions.Operations
{
    ...
    [ArithmeticOperation(OberonGrammarLexer.MINUS, BaseTypes.Int, BaseTypes.Int, BaseTypes.Int)]
    [ArithmeticOperation(OberonGrammarLexer.MINUS, BaseTypes.Int, BaseTypes.Decimal, BaseTypes.Decimal)]
    [ArithmeticOperation(OberonGrammarLexer.MINUS, BaseTypes.Decimal, BaseTypes.Decimal, BaseTypes.Decimal)]
    [ArithmeticOperation(OberonGrammarLexer.MINUS, BaseTypes.Decimal, BaseTypes.Int, BaseTypes.Decimal)]
    [UsedImplicitly]
