#region copyright
// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpSubNumber.cs" company="Stephen Reindl">
// Copyright (c) Stephen Reindl. All rights reserved.
// Licensed under the MIT license. See LICENSE.md file in the project root for full license information.
// </copyright>
// <summary>
//     Part of oberon0 - Oberon0Compiler/OpSubNumber.cs
// </summary>
// --------------------------------------------------------------------------------------------------------------------
#endregion
...
namespace Oberon0.Compiler.Expressions.Operations
{
    ...
    [ArithmeticOperation(OberonGrammarLexer.MINUS, BaseTypes.IntType, BaseTypes.IntType, BaseTypes.IntType)]
    [ArithmeticOperation(OberonGrammarLexer.MINUS, BaseTypes.IntType, BaseTypes.DecimalType, BaseTypes.DecimalType)]
    [ArithmeticOperation(OberonGrammarLexer.MINUS, BaseTypes.DecimalType, BaseTypes.DecimalType, BaseTypes.DecimalType)]
    [ArithmeticOperation(OberonGrammarLexer.MINUS, BaseTypes.DecimalType, BaseTypes.IntType, BaseTypes.DecimalType)]
    [UsedImplicitly]
